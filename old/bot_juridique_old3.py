...
"""
    ...
    if corrected_answer != response.content:
     ...
     # 6. Validation des citations contre les sources
    validated_answer = validate_citations_against_sources(corrected_answer, sources_list)
    
    # AJOUTEZ CE LOG POUR VÉRIFIER CE QUI EST RETOURNÉ
    print(f"🔍 VALEUR RETOURNÉE DANS result['answer'] : {corrected_answer[:100]}...\n")
